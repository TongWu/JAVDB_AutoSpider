# IMP-013: ADR-010 Phase 2 — D1 Recovery Outbox Enablement
...
**Source spec:** [ADR-010](../adr/ADR-010-d1-access-port.md), D5-D7, D10 Phase 2, D11.
...
| `docs/en/ops/d1-rollback.md`, `docs/zh/ops/d1-rollback.md` | Operator runbook for inspect/replay/dead letters. |
...
**Files:**
- Modify: `docs/en/ops/d1-rollback.md`
- Modify: `docs/zh/ops/d1-rollback.md`
...
Add the Chinese equivalent to `docs/zh/ops/d1-rollback.md`.
...
```bash
rg -n "d1_recovery_outbox|d1_recovery replay|D1 Recovery Outbox" docs/en/ops/d1-rollback.md docs/zh/ops/d1-rollback.md
```
...
```bash
git add docs/en/ops/d1-rollback.md docs/zh/ops/d1-rollback.md
