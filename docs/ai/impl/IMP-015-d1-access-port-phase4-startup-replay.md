...
| `docs/en/ops/d1-rollback.md`, `docs/zh/ops/d1-rollback.md` | Document startup replay switch and failure response. |
...
rg -n "startup-drain|D1_STARTUP_REPLAY_ENABLED|Startup Replay" apps/cli/db/d1_recovery.py docs/en/ops/d1-rollback.md docs/zh/ops/d1-rollback.md
```
...
```bash
git add apps/cli/db/d1_recovery.py docs/en/ops/d1-rollback.md docs/zh/ops/d1-rollback.md
