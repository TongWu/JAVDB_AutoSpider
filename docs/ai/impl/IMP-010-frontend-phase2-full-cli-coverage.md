# IMP-010: Frontend Rewrite — Phase 2: Full CLI Surface Coverage
...
**Related:** [ADR-008](../adr/ADR-008-frontend-rewrite-architecture.md), [IMP-009](IMP-009-frontend-phase1-completion.md) (Phase 1), [IMP-011](IMP-011-frontend-phase3-power-user.md) (Phase 3)

**Prerequisites:** Phase 1 cutover complete ([IMP-009](IMP-009-frontend-phase1-completion.md) Task 6 done). FE Docker image published. `apps/web/` deleted.
