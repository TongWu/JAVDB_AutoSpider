...
- `docs/en/self-hoster/configuration.md` 和 `docs/zh/self-hoster/configuration.md`；
- `docs/en/ops/d1-rollback.md` 和 `docs/zh/ops/d1-rollback.md`；
...
- [`docs/zh/ops/d1-rollback.md`](../../zh/ops/d1-rollback.md) —— 当前 pending rollback 和 drift 响应 runbook。
