...
- **[ADR-005](ADR-005-db-py-retirement-and-repo-pattern.md) PR-2 (deferred)** — should explicitly consider L2a (idempotent bookkeeping) as a candidate inclusion when its design is revisited post-bake.
