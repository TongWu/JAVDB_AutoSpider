# IMP-ADR008-01: Frontend Phase 1 — Backend Prerequisites
...
| `docs/handbook/en/developer/api-reference.md` + `docs/handbook/zh/developer/api-reference.md` | Document the 10 new endpoints. |
...
- Modify: `docs/handbook/en/developer/api-reference.md`
- Modify: `docs/handbook/zh/developer/api-reference.md`
...
Open `docs/handbook/en/developer/api-reference.md`. Find the existing "Endpoints" section. Add a new subsection:
...
Open `docs/handbook/zh/developer/api-reference.md`. Add the paired Chinese section with the same structure (translate prose, keep paths/method names verbatim).

- [ ] **Step 4: Commit**

```bash
git add docs/api/openapi.json docs/handbook/en/developer/api-reference.md docs/handbook/zh/developer/api-reference.md
