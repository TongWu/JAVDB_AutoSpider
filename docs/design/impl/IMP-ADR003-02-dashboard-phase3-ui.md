...
**Related**: implements [ADR-003](../adr/archive/ADR-003-metrics-pipeline.md); requires [IMP-ADR003-01](IMP-ADR003-01-dashboard-phase2-worker-backend.md) deployed; prerequisite for [IMP-ADR002-01](IMP-ADR002-01-dashboard-phase4-history-drilldowns.md)
