...
**Related:** [ADR-008](../adr/ADR-008-frontend-rewrite-architecture.md), [IMP-ADR008-02](IMP-ADR008-02-frontend-phase1-completion.md) (Phase 1), [IMP-ADR008-04](IMP-ADR008-04-frontend-phase3-power-user.md) (Phase 3)
