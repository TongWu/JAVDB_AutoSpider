# IMP-017: ADR-011 Phase 2 — Parsing Caller Migration
...
- [ ] Add a clear module comment that this Adapter is temporary and deleted by IMP-018.
- [ ] Run:
...
- [ ] Confirm remaining hits are either active legacy callers intentionally deferred to IMP-018 or historical references.
