# IMP-022: ADR-012 Final Phase - Result Consumption Cleanup
...
**Prerequisite:** [IMP-020](IMP-020-pipeline-run-phase1-bake.md) passed and [IMP-021](IMP-021-pipeline-run-phase2-in-process-spider.md) is complete unless the final phase is explicitly limited to workflow result consumption.
