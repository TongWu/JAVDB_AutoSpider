# IMP-036: ADR-015 Phase 7 - Notify Cleanup
...
**Source spec:** [ADR-015](../adr/ADR-015-integrations-interface-boundary.md), D6, D8, and D10.
...
Use the responsibility boundaries from IMP-035. Do not leave production code
calling `_legacy.py`.
