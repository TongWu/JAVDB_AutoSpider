# IMP-027: ADR-014 Phase 1 - Guard And Direct Storage Imports
...
**Source spec:** [ADR-014](../adr/ADR-014-storage-cli-layering.md), D1-D3 and D9.
...
| `docs/design/impl/IMP-009-frontend-phase1-completion.md` | Add updated note for Task 4. |
...
- Modify: `docs/design/impl/IMP-009-frontend-phase1-completion.md`
...
- [ ] **Step 2: Add the IMP-009 Task 4 updated note.**

Add a short status note before the Task 4 context:

```text
2026-05-20 update: this task has been partially completed. The original storage-to-CLI import has moved to javdb.storage.rollback.session_helpers, while apps.cli.db._session_helpers remains a shim. ADR-014 and IMP-027 through IMP-029 track the final canonical module and wrapper deletion.
```
...
git add tests/architecture/test_storage_cli_layering.py \
        ...
        docs/design/impl/IMP-009-frontend-phase1-completion.md
