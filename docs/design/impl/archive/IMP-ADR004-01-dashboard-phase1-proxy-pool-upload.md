...
**Related**: implements [ADR-004](../../adr/archive/ADR-004-proxy-discovery-via-runner-pool-upload.md); prerequisite for [IMP-ADR003-01](../IMP-ADR003-01-dashboard-phase2-worker-backend.md)
