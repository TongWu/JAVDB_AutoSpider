# IMP-021: ADR-012 Phase 2 - In-Process Spider Runner
...
**Prerequisite:** [IMP-020](IMP-020-pipeline-run-phase1-bake.md) Phase 2 Unlock Gate is complete.
...
- [ ] [IMP-020](IMP-020-pipeline-run-phase1-bake.md) Phase 2 Unlock Gate is complete.
