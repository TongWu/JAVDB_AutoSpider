# IMP-031: ADR-015 Phase 2 - qB Command Packages
...
**Tech Stack:** Python 3.11, dataclasses, argparse, pytest, existing qB client/config helpers, `javdb.workflow` adapters from IMP-030.

**Source spec:** [ADR-015](../adr/ADR-015-integrations-interface-boundary.md), D1-D7.
