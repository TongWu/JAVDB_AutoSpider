...
**Status**: Accepted - Phase 1 complete (signed off 2026-05-25); Phase 2 complete (verified 2026-05-25); final phase pending
**Date**: 2026-05-20
...
- Phase 2 - Pipeline calls Spider through an in-process runner while qB uploader, PikPak, email, and rclone dedup remain subprocess steps. Done and verified via [IMP-ADR012-03](IMP-ADR012-03-pipeline-run-phase2-in-process-spider.md).
