...
| Field       | Value                                                                 |
| ----------- | --------------------------------------------------------------------- |
| **Status**  | Partially implemented — Phase 1 (2026-06-14) & Phase 2 (2026-06-19) shipped; **Phase 3 not started** (the folder-dedup cascade still lives in Python — `dedup.py`'s cascade + `SIZE_THRESHOLD_RATIO` remain live production consumers until Phase 3). Execution tracked in [IMP-ADR048-01](IMP-ADR048-01-module-split-and-rust-folder-dedup.md) (3 phases) |
| **Date**    | 2026-06-13                                                            |
| **Authors** | Ted                                                                   |
