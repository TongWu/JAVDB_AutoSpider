...
Merged from [ADR-028](ADR-028-web-platform-completeness-roadmap.md) workstream WS-A (P0). Two parity gaps undermine *capability honesty* — the platform advertising work it cannot track or execute.
...
并入自 [ADR-028](ADR-028-web-platform-completeness-roadmap.md) 的工作流 WS-A（P0）。两个对等缺口损害了*能力诚实性*——平台宣称了它无法追踪或执行的工作。
