...
**关联实现计划 (Related Implementation Plans)**：[IMP-ADR013-01](IMP-ADR013-01-runner-runtime-phase1-skeleton-facade.md)（Phase 1 - runtime skeleton and active facade — **已完成 2026-05-26**）、[IMP-ADR013-02](IMP-ADR013-02-runner-runtime-phase2-registry-movieclaim.md)（Phase 2 - registry and MovieClaim lifecycle — **已完成 2026-05-26**）、[IMP-ADR013-03](IMP-ADR013-03-runner-runtime-phase3-explicit-callers.md)（Phase 3 - explicit production callers — **已完成 2026-05-27**）、[IMP-ADR013-04](IMP-ADR013-04-runner-runtime-phase4-legacy-facade-removal.md)（Phase 4 - legacy facade freeze/removal —— **已完成 2026-05-27**）
...
- ~~Phase 2 - 将 RunnerRegistry heartbeat/session lifecycle 和 MovieClaim auto lifecycle 迁到 runtime-owned state/services。~~ **已完成 2026-05-26**（IMP-ADR013-02）。
- ~~Phase 3 - 将 sleep、proxy、request、login、fetch、detail、report 的生产调用方逐步迁到显式 runtime/context。~~ **已完成 2026-05-27**（IMP-ADR013-03）。
- ~~Phase 4 - freeze 或删除 legacy direct-mutation `state.py` compatibility，并记录最终显式 runtime 使用规则。~~ **已完成 2026-05-27**（IMP-ADR013-04）。
...
- [IMP-ADR013-02](IMP-ADR013-02-runner-runtime-phase2-registry-movieclaim.md) — Phase 2：RunnerRegistry + MovieClaim lifecycle。**已完成 2026-05-26。**
- [IMP-ADR013-03](IMP-ADR013-03-runner-runtime-phase3-explicit-callers.md) — Phase 3：显式 production callers。**已完成 2026-05-27。**
- [IMP-ADR013-04](IMP-ADR013-04-runner-runtime-phase4-legacy-facade-removal.md) — Phase 4：legacy facade freeze/removal。**已完成 2026-05-27。**
