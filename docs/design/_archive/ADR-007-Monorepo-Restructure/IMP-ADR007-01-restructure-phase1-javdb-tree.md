# IMP-ADR007-01: ADR-007 Phase 1 — Build the `javdb/` Tree
...
**Source spec:** [ADR-007](ADR-007-monorepo-restructure-2026-05.md) (English version is canonical).
...
**File:**
- Create: `docs/design/adr/ADR-007-deletion-manifest.md`
...
Use the Write tool to create `docs/design/adr/ADR-007-deletion-manifest.md`. Structure:
...
**Generated:** `git log -1 --format='%H %ai' -- docs/design/adr/ADR-007-deletion-manifest.md` (replace with real values after commit)
```
...
```bash
[ -s docs/design/adr/ADR-007-deletion-manifest.md ] && wc -l docs/design/adr/ADR-007-deletion-manifest.md
```
...
- Link to ADR-007 (`docs/design/adr/ADR-007-monorepo-restructure-2026-05.md`)
- Link to the deletion manifest (`docs/design/adr/ADR-007-deletion-manifest.md`)
...
See `docs/design/impl/archive/IMP-ADR007-02-restructure-phase2-scripts-to-cli.md`.
