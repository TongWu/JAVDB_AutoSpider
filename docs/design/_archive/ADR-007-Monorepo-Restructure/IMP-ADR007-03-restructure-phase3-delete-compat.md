# IMP-ADR007-03: ADR-007 Phase 3 — Delete Compat Shells (Precision Deletion Against Manifest)
...
**Source spec:** [ADR-007](ADR-007-monorepo-restructure-2026-05.md) §"Phase 3" + [ADR-007-deletion-manifest.md](ADR-007-deletion-manifest.md) (the canonical checklist).
...
IMP-ADR007-01 and IMP-ADR007-02 already swept Plan A's static imports during their bulk passes. This phase must still **verify the integration end-to-end** at the deletion + Dockerfile-cleanup + docs-rewrite boundaries — see the call-outs inside Task 1, Task 5, and the new **Gate 13** below.
...
This is the current canonical layout, established by [ADR-007](ADR-007-monorepo-restructure-2026-05.md).
...
### 4. `scripts/` had 5 more compat shells than IMP-ADR007-03 anticipated
