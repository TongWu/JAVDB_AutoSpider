# IMP-ADR007-02: ADR-007 Phase 2 — Migrate `scripts/` Real Code to `apps/cli/`
...
**Source spec:** [ADR-007](ADR-007-monorepo-restructure-2026-05.md) §"Phase 2 — Migrate scripts/ to apps/cli/" (English version is canonical).
...
This separation was established by [ADR-007](ADR-007-monorepo-restructure-2026-05.md) (Phase 2).
```
...
See `docs/design/impl/archive/IMP-ADR007-03-restructure-phase3-delete-compat.md`.
