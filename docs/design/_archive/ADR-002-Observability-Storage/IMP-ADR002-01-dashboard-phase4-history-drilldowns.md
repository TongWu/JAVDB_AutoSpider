...
**Related**: implements [ADR-002](ADR-002-observability-data-storage-topology.md); requires [IMP-ADR003-02](../ADR-003-Metrics-Pipeline/IMP-ADR003-02-dashboard-phase3-ui.md) deployed; final phase of the dashboard rewrite
...
**Reference docs:** [ADR-002](ADR-002-observability-data-storage-topology.md), [CONTEXT.md](../../../../CONTEXT.md). User-facing decisions: grill-me Q5a (γ drawer mode), Q5d (chart locations), Q6a (drawer shell).
