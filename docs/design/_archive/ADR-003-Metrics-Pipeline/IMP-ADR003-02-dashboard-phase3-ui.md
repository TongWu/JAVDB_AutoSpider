# IMP-ADR003-02: Dashboard Overhaul — Phase 3: Main Dashboard UI

**Status**: Accepted — Planned
**Date**: 2026-05-16
**Deciders**: Proxy Coordinator Dashboard rewrite working stream
**Related**: implements [ADR-003](ADR-003-metrics-pipeline.md); requires [IMP-ADR003-01](IMP-ADR003-01-dashboard-phase2-worker-backend.md) deployed; prerequisite for [IMP-ADR002-01](../ADR-002-Observability-Storage/IMP-ADR002-01-dashboard-phase4-history-drilldowns.md)
...
**Reference docs:** [ADR-003](ADR-003-metrics-pipeline.md), [CONTEXT.md](../../../../CONTEXT.md). User-facing visual decisions captured in `grill-me` Q1-Q6 (5 Apr 2026 conversation).
 ...
 *
 * See docs/design/adr/ADR-003 for the data-pipeline design that feeds this UI.
 */
