...
**Status:** Implemented on 2026-05-22. PR-5 followed in [IMP-ADR005-02](IMP-ADR005-02-delete-db-facade.md) and removed `javdb/storage/db/db.py`; the remaining `javdb/storage/db/*.py` files are canonical modules, not ADR-001 shell facades.
