...
**状态**: 已完成 —— Phase 1+2 已交付（下列 9 个模块均存在于 `javdb/storage/db/`）。Phase 3（"删除 `db.py` 门面"）从未启动；由 [ADR-005](../ADR-005-Db-Py-Retirement/ADR-005-db-py-retirement-and-repo-pattern.md) 接管为正式退役路径。
**日期**: 2026-05-15
**决策者**: 架构重构团队
...
- [docs/handbook/en/ops/d1-rollback.md](../../../handbook/en/ops/d1-rollback.md) — 存储后端架构
