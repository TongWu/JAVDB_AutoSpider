...
**Status**: Completed — Phases 1+2 shipped (the 9 modules listed below all exist under `javdb/storage/db/`). Phase 3 ("delete `db.py` façade") was never started; superseded by [ADR-005](../ADR-005-Db-Py-Retirement/ADR-005-db-py-retirement-and-repo-pattern.md), which is now the canonical retirement path.
**Date**: 2026-05-15
...
- [docs/handbook/en/ops/d1-rollback.md](../../../handbook/en/ops/d1-rollback.md) — storage backend architecture
