...
**Date:** 2026-05-22
**Author:** Ted
**Related Implementation Plans:** [IMP-ADR016-01](../impl/IMP-ADR016-01-design-docs-folder-restructure.md) (single-phase restructure)
...
| --- | --- | --- | --- |
| Phase 1 | [IMP-ADR016-01](../impl/IMP-ADR016-01-design-docs-folder-restructure.md) | Python migration script, all file moves, cross-reference updates, ADR templates, CLAUDE.md updates | — |
