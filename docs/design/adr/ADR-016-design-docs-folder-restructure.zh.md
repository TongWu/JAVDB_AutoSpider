...
**日期 (Date):** 2026-05-22
**作者 (Author):** Ted
**关联实现计划 (Related Implementation Plans):** [IMP-ADR016-01](../impl/IMP-ADR016-01-design-docs-folder-restructure.md)（单阶段重构）
...
| 阶段 | IMP | 交付内容 | 推迟内容 |
| --- | --- | --- | --- |
| Phase 1 | [IMP-ADR016-01](../impl/IMP-ADR016-01-design-docs-folder-restructure.md) | Python 迁移脚本、所有文件移动、交叉引用更新、ADR 模板、CLAUDE.md 更新 | — |
