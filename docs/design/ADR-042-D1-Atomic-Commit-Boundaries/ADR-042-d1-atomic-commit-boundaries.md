...
| Field       | Value                                                                 |
| ----------- | --------------------------------------------------------------------- |
| **Status**  | Accepted — codifies the current boundary between D1 transport, session-level history, and additive enrichment |
| **Date**    | 2026-05-31                                                            |
| **Authors** | Ted                                                                   |
...
- [ADR-005 — Db Py Retirement and Repo Pattern](../_archive/ADR-005-Db-Py-Retirement/ADR-005-db-py-retirement-and-repo-pattern.md)
- [ADR-009 — D1 Drift Classifier](../_archive/ADR-009-D1-Drift-Classifier/ADR-009-d1-drift-classifier-and-diagnose.md)
