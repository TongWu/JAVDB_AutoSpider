...
| Field       | Value                                                                 |
| ----------- | --------------------------------------------------------------------- |
| **Status**  | Accepted — Phase 1 (Python golden) implemented 2026-05-29; Phase 2 (TS consume + dispatch) implemented 2026-05-30 (pending merge + ops: `WEB_REPO_DISPATCH_TOKEN`) |
| **Date**    | 2026-05-29                                                            |
| **Authors** | Ted                                                                   |
