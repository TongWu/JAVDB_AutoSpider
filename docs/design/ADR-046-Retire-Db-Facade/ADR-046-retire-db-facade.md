...
| Field       | Value                                                                 |
| ----------- | --------------------------------------------------------------------- |
| **Status**  | Accepted — Phase 1 implemented 2026-06-02 (branch `adr046-p1-history-write-seam`); Phases 2–5 pending. See IMP-ADR046-01 |
| **Date**    | 2026-06-02                                                            |
| **Authors** | Ted                                                                   |
...
| Phase 4 — privatize `db_*` | IMP-ADR046-04 | Drop the `db_*` re-exports from `__init__.py`/`__all__` (facade fns with repo equivalents); add the 7 missing repo wrappers first; migrate remaining callers + tests | — |
