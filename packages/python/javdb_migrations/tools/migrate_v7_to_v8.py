...
def run_schema_migration(
    *,
    ...
    if not os.path.exists(h):
        ...
        logger.info("If you still use a single legacy DB, run packages/python/javdb_migrations/tools/migrate_v6_to_v7_split.py first.")
        return 1
    ...
    if hist_ver < 7:
        ...
        logger.info("Run packages/python/javdb_migrations/tools/migrate_v6_to_v7_split.py (or init_db) before upgrade.")
        return 1
