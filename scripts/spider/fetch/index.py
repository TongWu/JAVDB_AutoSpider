...
from utils.domain.url_helper import detect_url_type
from utils.domain.filename_helper import generate_output_csv_name_from_html
...
from scripts.spider.fetch.fallback import get_page_url, fetch_index_page_with_fallback
from scripts.spider.runtime.sleep import movie_sleep_mgr
from scripts.spider.runtime.config import PAGE_SLEEP, PROXY_POOL, PROXY_MODE
