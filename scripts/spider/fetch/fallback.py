...
from utils.bridges.rust_adapters.parser_adapter import validate_index_html as _validate_index_html_fast
from utils.domain.url_helper import get_page_url as _url_helper_get_page_url

import scripts.spider.runtime.state as state
from scripts.spider.fetch.session import is_login_page, can_attempt_login, attempt_login_refresh
