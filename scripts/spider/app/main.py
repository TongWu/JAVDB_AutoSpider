...
from utils.domain.filename_helper import generate_output_csv_name
from utils.infra.path_helper import ensure_dated_dir
from utils.infra.csv_writer import set_active_session
...
def main():
    ...
    try:
        ...
        if _use_sqlite():
            from utils.infra.db import init_db, db_create_report_session
            from utils.domain.url_helper import detect_url_type, extract_url_identifier
            init_db()
    ...
    if _session_id is not None:
        try:
            from utils.infra.db import db_save_spider_stats, get_db, REPORTS_DB_PATH
