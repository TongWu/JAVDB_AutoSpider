...
class TestPerProxyLoginRouting:
    """Test attempt_login_refresh function signature and contract.

    Worker-level login routing (login_page detection, CF short-circuit,
    login_queue routing, cookie handoff) is covered by
    tests/integration/test_spider_integration.py::TestIndexRequiresLogin,
