...
class TestHistoryRepoReads:
    ...
    @patch(
        "javdb.storage.db._db_history_read.db_load_history",
    ...
    @patch(
        "javdb.storage.db._db_history_read.db_load_history_snapshot",
    ...
    @patch(
        "javdb.storage.db._db_history_read.db_check_torrent_in_history",
        return_value=True,
    )
    ...
    @patch(
        "javdb.storage.db._db_history_read.db_get_all_history_records",
        return_value=[{"Id": 1}],
    )
...
class TestHistoryRepoWrites:
    ...
    @patch(
        "javdb.storage.db._db_history_write.db_stage_history_write",
    ...
    @patch(
        "javdb.storage.db._db_history_write.db_commit_session_history",
    ...
    @patch(
        "javdb.storage.db._db_history_write.db_batch_update_last_visited",
        return_value=2,
    )
