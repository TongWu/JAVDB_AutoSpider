...
class TestStatsRepoSave:
    ...
    @patch("javdb.storage.db.db_stats.db_save_spider_stats", return_value=42)
    ...
    @patch("javdb.storage.db.db_stats.db_save_uploader_stats", return_value=7)
    ...
    @patch("javdb.storage.db.db_stats.db_save_pikpak_stats", return_value=3)
...
class TestStatsRepoRead:
    ...
    @patch("javdb.storage.db.db_stats.db_get_uploader_stats", return_value=None)
