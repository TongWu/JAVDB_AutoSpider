...
class TestStatsRepoSave:
    ...
    @patch("javdb.storage.db._db_stats.db_save_spider_stats", return_value=42)
    ...
    @patch("javdb.storage.db._db_stats.db_save_uploader_stats", return_value=7)
    ...
    @patch("javdb.storage.db._db_stats.db_save_pikpak_stats", return_value=3)
...
class TestStatsRepoRead:
    ...
    @patch(
        "javdb.storage.db._db_stats.db_get_spider_stats",
    ...
    @patch("javdb.storage.db._db_stats.db_get_uploader_stats", return_value=None)
    def test_get_uploader_stats_returns_none(self, mock_fn):
        repo = StatsRepo()
        assert repo.get_uploader_stats("missing") is None

    @patch(
        "javdb.storage.db._db_stats.db_get_pikpak_stats",
...
class TestStatsRepoLocalRead:
    ...
    @patch(
        "javdb.storage.db._db_stats.db_get_spider_stats_local",
    ...
    @patch(
        "javdb.storage.db._db_stats.db_get_uploader_stats_local",
        return_value=None,
    )
    ...
    @patch(
        "javdb.storage.db._db_stats.db_get_pikpak_stats_local",
