...
class TestOperationsRepoRcloneInventory:
    ...
    @patch(
        "javdb.storage.db._db_operations.db_load_rclone_inventory",
    ...
    @patch(
        "javdb.storage.db._db_operations.db_replace_rclone_inventory",
        return_value=5,
    )
    ...
    @patch("javdb.storage.db._db_operations.db_clear_rclone_inventory")
    ...
    @patch(
        "javdb.storage.db._db_operations.db_append_rclone_inventory",
        return_value=3,
    )
...
class TestOperationsRepoDedup:
    ...
    @patch(
        "javdb.storage.db._db_operations.db_load_dedup_records",
        return_value=[{"Id": 1}],
    )
    ...
    @patch("javdb.storage.db._db_operations.db_save_dedup_records")
    ...
    @patch(
        "javdb.storage.db._db_operations.db_append_dedup_record",
        return_value=9,
    )
    ...
    @patch("javdb.storage.db._db_operations.db_append_dedup_record")
...
class TestOperationsRepoDedupLifecycle:
    ...
    @patch(
        "javdb.storage.db._db_operations.db_mark_orphan_records",
        return_value=1,
    )
...
class TestOperationsRepoRcloneStaging:
    ...
    @patch(
        "javdb.storage.db._db_operations.db_open_rclone_staging",
    ...
    @patch(
        "javdb.storage.db._db_operations.db_append_rclone_staging",
        return_value=3,
    )
    ...
    @patch(
        "javdb.storage.db._db_operations.db_merge_rclone_inventory_from_stage",
        return_value=50,
    )
    ...
    @patch("javdb.storage.db._db_operations.db_drop_rclone_staging")
    ...
    @patch(
        "javdb.storage.db._db_operations.db_delete_rclone_inventory_paths",
        return_value=2,
    )
...
class TestOperationsRepoAlignNoExactMatch:
    ...
    @patch(
        "javdb.storage.db._db_operations.db_load_align_no_exact_match_codes",
    ...
    @patch("javdb.storage.db._db_operations.db_delete_align_no_exact_match")
...
class TestOperationsRepoPikpak:
    ...
    @patch(
        "javdb.storage.db._db_operations.db_append_pikpak_history",
        return_value=10,
    )
    ...
    @patch("javdb.storage.db._db_operations.db_append_pikpak_history")
