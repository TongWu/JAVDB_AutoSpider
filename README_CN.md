...
规范布局由 [ADR-007](docs/design/adr/archive/ADR-007-monorepo-restructure-2026-05.zh.md) 确立；所有旧路径（`utils/`、`api/`、`migration/`、`legacy/`、`scripts/spider/`、`scripts/ingestion/`、根目录 `compat.py`/`pipeline.py`）已在 Phase 3 移除。
