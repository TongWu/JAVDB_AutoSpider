...
# Canonical implementation moved to db_session.py; re-exported here for
# backwards compatibility.  Importing from db_session ensures a single
# set of globals (counters, locks, process tags) across all code paths.
import javdb.storage.db.db_session as _db_session_mod  # noqa: E402

_SESSION_ID_LOCK = _db_session_mod._SESSION_ID_LOCK
_SESSION_ID_PROCESS_TAG_BITS = _db_session_mod._SESSION_ID_PROCESS_TAG_BITS
_SESSION_ID_PROCESS_TAG = _db_session_mod._SESSION_ID_PROCESS_TAG
_SESSION_ID_TAG_HEX = _db_session_mod._SESSION_ID_TAG_HEX
_SESSION_ID_PATTERN = _db_session_mod.SESSION_ID_PATTERN
_generate_session_id = _db_session_mod.generate_session_id

# Integer ID generation — single source of truth in db_session.py
_INT_ID_EPOCH_BASE_MS = _db_session_mod._INT_ID_EPOCH_BASE_MS
_INT_ID_PROCESS_TAG = _db_session_mod._INT_ID_PROCESS_TAG
_INT_ID_LOCK = _db_session_mod._INT_ID_LOCK
_generate_integer_id = _db_session_mod.generate_integer_id
