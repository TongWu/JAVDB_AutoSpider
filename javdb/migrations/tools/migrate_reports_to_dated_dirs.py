...
Usage:
    ...
    python packages/python/javdb_migrations/tools/migrate_reports_to_dated_dirs.py --dry-run
    
    # Execute migration
    python packages/python/javdb_migrations/tools/migrate_reports_to_dated_dirs.py
    
    # Force migration even if target exists
    python packages/python/javdb_migrations/tools/migrate_reports_to_dated_dirs.py --force
"""
