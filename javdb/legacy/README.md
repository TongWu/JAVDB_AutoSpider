...
- [ADR-007](../../docs/ai/adr/archive/ADR-007-monorepo-restructure-2026-05.md)
  — restructure decision that retired the original `legacy/` location
- [`../../docs/ai/architecture/python-tree-2026-05.md`](../../docs/ai/architecture/python-tree-2026-05.md)
